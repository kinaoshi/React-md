...
> に変更して、保存して確認すると、title と body が表示されている
...
return {
  ...
  user,
  error: postError || userError,
  isLading: !post && !postError && !user && !userError,
};
```
...
> を切り取りして、hooks/usePost.jsx にペースト
